...
func amplifierSequence(program *intcode.Intcode, phaseSequence []int) int {
...
func solve(program *intcode.Intcode, phases []int) int {
	maxOutput := 0
	Perm(phases, func(phaseSequence []int) {
...
func solvePart1(program *intcode.Intcode) int {
	return solve(program, []int{0, 1, 2, 3, 4})
}

func solvePart2(program *intcode.Intcode) int {
	return solve(program, []int{5, 6, 7, 8, 9})
}
